...
<body>
            ...
            <!-- tooogle button for moble navbar -->
            <!-- 
                data-bs-collapse:collapse(holia data li clase dyalha smitha colapse)
                collapse:element pliable uitilise bach afficher masque whd contenu quantiti dyalo kbira
                data-bs-target="#demo": hadi element howa likidir lina connection bin dak element button li3ndo class=collapse o element libginah afficha div id=demo
                ...
                <form class="d-flex ms-auto">
                    <div class="input-group my-3">
                        <!-- <input type="text" class="form-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2"> -->
                            <button class="btn bt text-white" type="button" id="button-addon2">
                                <i class="bi bi-search">imane</i>
                            </button>
                    </div>
                </form>
